...
jQuery('.ans_btn').click(function() {
    ...
    if((jQuery('#first').attr('data-click-state') == 1) && (jQuery('#third').attr('data-click-state') == 1) && (jQuery('#fourth').attr('data-click-state') == 1) && (jQuery('#sixth').attr('data-click-state') == 1) ) {
         jQuery("#eighth").css('border', '2px solid green');
         jQuery("#eighth").css('background-color', '#90EE90');
         jQuery('.btn_icon').html('<span><img src="https://whytowiki.com/scion/public/check.svg" class="icon_img"/></span>  <span class="tooltip__content"><p class="tooltip_header">Correct <span class="tooltip_img"><img src="https://whytowiki.com/scion/public/check.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> None of the terms should be cancelled. Click on any of the terms to reset the question.</p></span>');
        ...
        jQuery('.btn_icon').html('<span><img src="https://whytowiki.com/scion/public/remove.svg" class="icon_img"/></span> <span class="tooltip__content"><p class="tooltip_header">Incorrect <span class="tooltip_img"><img src="https://whytowiki.com/scion/public/remove.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> None of the terms should be cancelled. Click on any of the terms to reset the question.</p></span>');
        jQuery('.btn_icon').css('visibility', 'visible');
        jQuery("#ans_btn").css('visibility', 'hidden');
    }    
