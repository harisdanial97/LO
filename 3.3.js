...
$('.ans_btn').click(function() {
	...
	jQuery('#ninth').html('<span><img src="https://whytowiki.com/scion/public/check.svg" class="icon_img"/></span> <span class="tooltip__content"><p class="tooltip_header">Correct <span class="tooltip_img"><img src="https://whytowiki.com/scion/public/check.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Incompressible Flow and hence \\({{\\partial *} \\over {\\partial t}} = 0\\)</p></span>');
    ...
    MathJax.startup.defaultReady();
		...
		jQuery('#ninth').html('<span><img src="https://whytowiki.com/scion/public/remove.svg" class="icon_img"/></span>  <span class="tooltip__content"><p class="tooltip_header">Incorrect <span class="tooltip_img"><img src="https://whytowiki.com/scion/public/remove.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Incompressible Flow and hence \\({{\\partial *} \\over {\\partial t}} = 0\\)</p></span>');
		jQuery('#ninth').css('font-size', '8px');
        document.getElementById("ninth").style.visibility = "visible";
        MathJax.startup.defaultReady();
	}
	...
	if (answer.value == "b2") {
		...
		jQuery('#tenth').html('<span><img src="https://whytowiki.com/scion/public/check.svg" class="icon_img"/></span> <span class="tooltip__content"><p class="tooltip_header">Correct <span class="tooltip_img"><img src="https://whytowiki.com/scion/public/check.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Fully developed flow in x direction and hence \\({{\\partial *} \\over {\\partial x}} = 0\\) </p></span>');
		...
		jQuery('#tenth').html('<span><img src="https://whytowiki.com/scion/public/remove.svg" class="icon_img"/></span>  <span class="tooltip__content"><p class="tooltip_header">Incorrect <span class="tooltip_img"><img src="https://whytowiki.com/scion/public/remove.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Fully developed flow in x direction and hence \\({{\\partial *} \\over {\\partial x}} = 0\\)</p></span>');
		jQuery('#tenth').css('font-size', '8px');
        document.getElementById("tenth").style.visibility = "visible";
        MathJax.startup.defaultReady();
	}
	...
	if (answer.value == "d2") {
		...
		jQuery('#twelfth').html('<span><img src="https://whytowiki.com/scion/public/check.svg" class="icon_img"/></span> <span class="tooltip__content"><p class="tooltip_header">Correct <span class="tooltip_img"><img src="https://whytowiki.com/scion/public/check.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> 2D flow in x and y only. Hence, \\({{\\partial *} \\over {\\partial z}} = 0\\)</p></span>');
		...
		jQuery('#twelfth').html('<span><img src="https://whytowiki.com/scion/public/remove.svg" class="icon_img"/></span>  <span class="tooltip__content"><p class="tooltip_header">Incorrect <span class="tooltip_img"><img src="https://whytowiki.com/scion/public/remove.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> 2D flow in x and y only. Hence, \\({{\\partial *} \\over {\\partial z}} = 0\\)</p></span>');
		jQuery('#twelfth').css('font-size', '8px');
        document.getElementById("twelfth").style.visibility = "visible";
        MathJax.startup.defaultReady();
	}
	...
	function flow_checkbox() {
	  ...
	  console.log(secound_section);
		if(secound_section == 4){
		    jQuery(".final").show();   
			frame = 3;
			jQuery('.flow_btn_icon').html('<span><img src="https://whytowiki.com/scion/public/check.svg" class="icon_img"/></span>  <span class="tooltip__content"><p class="tooltip_header">Correct <span class="tooltip_img"><img src="https://whytowiki.com/scion/public/check.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Incompressible flow, fully developed flow in x, and 2D flow in x and y only</p></span>');
		jQuery('.btn_icon').css('visibility', 'visible');
        jQuery('#ans_btn').css('visibility', 'hidden');
        ...
        jQuery("#nineteenth_check .output_box").css('visibility', 'visible');
            ...
            frame = 2;
		jQuery(".final").hide();  	
		jQuery('.flow_btn_icon').html('<span><img src="https://whytowiki.com/scion/public/remove.svg" class="icon_img"/></span>  <span class="tooltip__content"><p class="tooltip_header">Incorrect <span class="tooltip_img"><img src="https://whytowiki.com/scion/public/remove.svg" class="icon_img"/></span></p><p class="contant_tooltip"><b>Correct Answer:</b> Incompressible flow, fully developed flow in x, and 2D flow in x and y only</p></span>');
		jQuery('.btn_icon').css('visibility', 'visible');
        jQuery('#ans_btn').css('visibility', 'hidden');
        jQuery('.flow_btn_special').css('visibility', 'hidden');
        jQuery('.flow_btn_icon').css('visibility', 'visible');
...
document.getElementById("check-final").addEventListener("click",function(){
    ...
    if(parseFloat(flux1) == 0 || flux1 == "2h"){
        ...
        document.getElementsByClassName("tooltip1")[0].innerHTML = '<span class="tooltip__content1"><p class="tooltip_header1">Correct <span class="tooltip_img1"><img src="https://whytowiki.com/scion/public/check.svg" class="icon_img"/></span></p><p class="contant_tooltip1"><b>Correct Answer:</b> 0 or 2h</p></span>';
    jQuery("#check-final").css('visibility', 'visible');
        ...
        document.getElementsByClassName("tooltip1")[0].innerHTML = '<span class="tooltip__content1"><p class="tooltip_header1">Incorrect <span class="tooltip_img1"><img src="https://whytowiki.com/scion/public/remove.svg" class="icon_img"/></span></p><p class="contant_tooltip1"><b>Correct Answer:</b> 0 or 2h</p></span>';
    }
    ...
    if((parseFloat(flux1) == 0 || flux1 == "2h" )&& parseFloat(flux2) == 0){
